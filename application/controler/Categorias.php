...
class Categorias {
	...
	function Listar(){
		...
		echo '<tr class="css-form">
				...
				<td class="header">Editar</td>
				<td class="header">Produtos Cadastrados</td>
				</tr>';
		while($produto=mysql_fetch_array($produtos)){
			...
			echo '<td><a href="main.php?url=produto&acao=formbuscaprodcat&id='.$produto['id'].'">Visualizar Produtos</a></td>';
