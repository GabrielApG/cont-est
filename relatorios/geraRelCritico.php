...
$sql= "SELECT * from SRS_PRODUCT WHERE estoque_atual<=estoque_minimo";//, b.nome
...
$connect = mysql_connect("localhost","root","");
	...
	$exe_sql=mysql_query($sql) or die (mysql_error());
		...
		$pdf->Cell(0,1,'Almoxarifado Iveco Sete Lagoas - RELATORIO DE ESTOQUE CRITICO',0,0,'L');
		$pdf->Ln(1);		
	...
	while($resultado=mysql_fetch_array($exe_sql)){
		...
		$pdf->Cell(3,1,$resultado['alocacao'],1,0,'L');
		$pdf->Ln(1);
