...
$sql= "SELECT * FROM SRS_REQUESTER ORDER BY nome";//, b.nome
...
$connect = mysql_connect("localhost","root","");
	...
	$exe_sql=mysql_query($sql) or die (mysql_error());
		...
		$pdf->Cell(0,1,'Almoxarifado Iveco Sete Lagoas - RETIRANTES DE PRODUTOS',0,0,'L');
		$pdf->Ln(1);		
	...
	while($resultado=mysql_fetch_array($exe_sql)){
		...
		$pdf->Cell(4,1,$resultado['empresa'],1,0,'L');
		$pdf->Ln(1);
